...
[原則索引](principles/index.md) / [構成例](references/architecture.md) / [成果物の形式](references/output-contracts.md) / [DB選択](references/database-selection.md) / [API規約](references/web-api.md) / [ログ規約](references/logging.md) / [テスト戦略](references/testing.md) / [公式資料と更新](references/sources.md) / [利用評価](evals/scenarios.md)
...
案件側の記録・検証は、対象の構造と既存の運用を調べて必要なものを作る。[今回の検証記録](references/verification-report.md)を参照。
